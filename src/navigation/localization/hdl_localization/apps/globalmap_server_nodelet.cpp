...
public:
  ...
  void onInit() override {
    ...
    globalmap_pub = nh.advertise<sensor_msgs::PointCloud2>("/localization/globalmap", 5, true);
    map_update_sub = nh.subscribe("/localization/map_request/pcd", 10, &GlobalmapServerNodelet::map_update_callback, this);
