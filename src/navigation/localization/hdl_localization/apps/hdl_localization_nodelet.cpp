...
public:
  ...
  void onInit() override {
    ...
    nh.getParam("/odom_frame_id", robot_odom_frame_id);
    ...
    globalmap_sub = nh.subscribe("/localization/globalmap", 1, &HdlLocalizationNodelet::globalmap_callback, this);
    initialpose_sub = nh.subscribe("/initialpose", 8, &HdlLocalizationNodelet::initialpose_callback, this);

    pose_pub = nh.advertise<nav_msgs::Odometry>(localization_topic, 5, false);
    aligned_pub = nh.advertise<sensor_msgs::PointCloud2>("/localization/aligned_points", 5, false);
    status_pub = nh.advertise<ScanMatchingStatus>("/localization/status", 5, false);
